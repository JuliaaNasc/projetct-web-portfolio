	...
	theme: {
		...
		extend: {
			colors: {
				...
				portfolio: {
					'blue': 'hsl(220, 91%, 56%)',
					'blue-dark': 'hsl(220, 91%, 45%)',
					'slate': 'hsl(220, 13%, 18%)',
					'slate-light': 'hsl(220, 13%, 91%)',
					'gray-50': 'hsl(220, 14%, 96%)',
					'gray-100': 'hsl(220, 13%, 91%)',
					'gray-200': 'hsl(220, 13%, 84%)',
					'gray-300': 'hsl(220, 14%, 71%)',
			...
			backgroundImage: {
				...
				'hero-gradient': 'linear-gradient(135deg, hsl(220, 91%, 56%) 0%, hsl(220, 91%, 45%) 50%, hsl(220, 13%, 18%) 100%)',
			}
		}
	},
